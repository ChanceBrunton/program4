...
{
	Circle1 circle1_2 = new Circle1(1,6,3);
	Assert.assertTrue(circle1.intersects(circle1_2));
}
...
{
	Circle1 circle1_2 = new Circle1(1,12,3);
	Assert.assertFalse(circle1.intersects(circle1_2));
}
...
{
	Circle1 circle1_2 = new Circle1(1,2,1);
	Assert.assertFalse(circle1.intersects(circle1_2));
}
